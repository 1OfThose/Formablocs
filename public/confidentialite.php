...
<h3>1.2 Éditeur : </h3>
 
<p>Formablocs  au capital de 5 000 €
dont le siège social est situé :   
représentée par Héloïse Zitouni, en sa qualité de Fondatrice
immatriculée au RCS de 522 365 568 000 13
n° de téléphone : 
adresse mail : contact@formablocs.com</p>
 
<h3>1.3 Hébergeur : </h3>
 
<p>Formablocs est hébergé par OVHCloud, dont le siège social est situé 2 rue Kellermann 59100 Roubaix.</p>
 
 
...
<ul><li>-  suspendre, interrompre ou limiter l'accès à tout ou partie du site, réserver l'accès au site, ou à certaines parties du site, à une catégorie déterminée d'internautes ;</li>
...
<li>-  suspendre le site afin de procéder à des mises à jour.</li></ul></p>
...
<li>-  du fait du non-respect par vous des présentes conditions générales.</li></ul>
 
...
Toute information accessible via un lien vers d'autres sites n'est pas publiée par l'éditeur. L'éditeur ne dispose d'aucun droit sur le contenu présent dans ledit lien.</p>

<h2>Article 7 - Collecte et protection des données</h2>
 
<p>Vos données sont collectées par la société Formablocs.
...
<li>- sujet du message et message (formulaire de contact)</li>
<li>- infos sur le parcours profrossionel des utilisateurs</li>
</ul></p>
 
...
<ul><li>· le droit d’accès : ils peuvent exercer leur droit d'accès, pour connaître les données personnelles les concernant, en écrivant à l'adresse électronique ci-dessous mentionnée. Dans ce cas, avant la mise en œuvre de ce droit, la Plateforme peut demander une preuve de l'identité de l'utilisateur afin d'en vérifier l'exactitude ;</li>
...
<li>· le droit à la portabilité : ils peuvent réclamer que la Plateforme leur remette les données personnelles qu'ils ont fournies pour les transmettre à une nouvelle Plateforme.</li></ul>
Vous pouvez exercer ce droit en nous contactant, à l’adresse suivante :
   . 00 rue NomDeRue, 00000 Ville, France
 
Ou par email, à l’adresse :
contact@formablocs.com    
 
...
 
Nous vous recommandons de nous contacter dans un premier temps avant de déposer une réclamation auprès de la CNIL, car nous sommes à votre entière disposition pour régler votre problème. </p>
 
...
<li>- lorsque l'utilisateur s'inscrit à la newsletter ;</li>
<li>- lorsque l'utilisateur envoie un message à FormaBlocs via l'onglet "Contact" ;</li>
<li>- lorsque l'utilisateur crée un compte et/ou se connecte à son espace personnel FormaBlocs ;</li>
<li>- lorsque l'utilisateur souscrit à une formation ou une certification ;</li>
<li>- lorsque l'utilisateur ajoute un message dans le forum de FormaBlocs.</li></ul></p>
 
...
 
<p>Les données personnelles peuvent être partagées avec des sociétés tierces exclusivement dans l’Union européenne, dans les cas suivants :
<ul><li>- quand l'utilisateur utilise les services de paiement, pour la mise en œuvre de ces services, la Plateforme est en relation avec des sociétés bancaires et financières tierces avec lesquelles elle a passé des contrats ;</li>
...
<li>- si la loi l'exige, la Plateforme peut effectuer la transmission de données pour donner suite aux réclamations présentées contre la Plateforme et se conformer aux procédures administratives et judiciaires.</li></ul></p>
 
<h2>Article 12 - Offres commerciales</h2>
 
<p>Vous êtes susceptible de recevoir des offres commerciales de l'éditeur. Si vous ne le souhaitez pas, veuillez cliquer sur le lien suivant : .
...
 
Les cookies suivants sont présents sur ce site : Aucun
  
...
<p>Pour toute question, information sur les produits présentés sur le site, ou concernant le site lui-même, vous pouvez laisser un message à l'adresse suivante : contact@formablocs.com.</p>
</section>
