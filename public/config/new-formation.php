...
if(!empty($_POST['formation'])){
	if ($_POST) {
		$sql = "INSERT INTO formations (formation, description, price, price_id, picto, link) VALUES (?,?,?,?,?,?)";
		$a = $pdo->prepare($sql)->execute([$_POST['prestation'], $_POST['price'], $_POST['price_id'], $_POST['picto'], $_POST['description'], $_POST['link']]);
			...
			<div class="admin-form-container">
				...
				<form method="post" action="" class="red-hover">
					...
					<div class="form-group">
						...
						<br>
						<input type="text" name="formation" id="name" required placeholder="Nom formation">
					</div>
					...
					<div class="form-group">
						...
						<br>
						<input type="text" name="picto" id="picto" value="ICONE FORMATION 2 - PROFIL.svg" required>
					</div>
