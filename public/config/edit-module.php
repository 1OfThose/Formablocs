...
if(!empty($_POST['module'])){
	if ($_POST) {
		...
		$sql = "UPDATE modules_formation_adultes SET module=:module, price=:price, price_id=:price_id, description=:description WHERE id=:id";
...
if ($_GET) {
	$stm = $pdo->query("SELECT * FROM modules_formation_adultes WHERE id=" . $_GET['id']);
